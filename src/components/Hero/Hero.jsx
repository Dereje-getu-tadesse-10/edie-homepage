...
export const Hero = () => {
    return (
        <section className="mt-16 mb-24 p-3">
            <div className="pl-10 pr-10 flex flex-col gap-1 md:pl-32 md:pr-32">
                <h2 className="text-blue ">
                    Unhappy with your wesite ?
                </h2>
                <h1 className="text-2xl text-gray font-medium md:w-[245px]">
            ...
            />
            <div className="mt-5 sm:w-[366px] pr-10 pl-10 md:ml-32 md:mr-32 md:pr-0 md:pl-0">
                <h3 className="text-2xl text-gray font-medium">
                    Story, emotion and purpose
                </h3>
                <p className="mt-4 font-normal text-secondGray">
            ...
            <div className="mt-5 pl-10 pr-10 md:ml-32 md:mr-32 md:pr-0 md:pl-0">
